...
zdfsubset1<-subset(zdf$zsquared,(zdf$zsquared>10) & (zdf$zsquared<100)) #with subset function
zdfsubset2<-zdf$zsquared[(zdf$zsquared>10) & (zdf$zsquared<100)] #without subset function
...
#We can see the data by clicking it in the environment that will open our file and we can check if the data is correct or not. The missing data will be replaced by N/A that will be read by R as the missing value.   
